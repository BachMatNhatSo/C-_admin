...
namespace WebsiteAdmin.Migrations
{
    ...
    partial class WebsiteAdminContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebsiteAdmin.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebsiteAdmin.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebsiteAdmin.Models.SinhVienSach", b =>
                {
                    b.HasOne("WebsiteAdmin.Models.Sach", "Sach")
                        .WithMany()
                        .HasForeignKey("SachId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebsiteAdmin.Models.SinhVien", "SinhVien")
                        .WithMany()
